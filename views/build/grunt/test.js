module.exports = function(grunt) {
    ...
    var testRunners = root + '/taoLtiConsumer/views/js/test/**/test.html';
    var testFiles = root + '/taoLtiConsumer/views/js/test/**/test.js';
    ...
    watch.taolticonsumer = {
        files : [testRunners, testFiles],
        tasks : ['qunit:taolticonsumer'],
        options : {
            debounceDelay : 10000
        }
    };
    ...
    // bundle task
    grunt.registerTask('taolticonsumertest', ['qunit:taolticonsumer']);
};
